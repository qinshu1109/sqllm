...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, groupRepository, usageLogRepository, userRepository, userSubscriptionRepository, gatewayCache, configConfig, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService)
	...
	chatCompletionsService := service.NewChatCompletionsService(gatewayService, accountRepository, groupRepository, gatewayCache, configConfig, billingService, billingCacheService, concurrencyService, httpUpstream, identityService)
	chatCompletionsHandler := handler.NewChatCompletionsHandler(chatCompletionsService, concurrencyService, billingCacheService, configConfig)
	handlerSettingHandler := handler.ProvideSettingHandler(settingService, buildInfo)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, chatCompletionsHandler, handlerSettingHandler)
