...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIChatService := service.NewOpenAIChatService(configConfig)
	openAIChatHandler := handler.NewOpenAIChatHandler(openAIChatService, geminiMessagesCompatService, antigravityGatewayService, apiKeyService)
	handlerSettingHandler := handler.ProvideSettingHandler(settingService, buildInfo)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, openAIChatHandler, handlerSettingHandler)
