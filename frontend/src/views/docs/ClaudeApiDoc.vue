...
const curlExample = `curl https://new.fastaiode.top/v1/messages \\
...
client = anthropic.Anthropic(
    ...
    base_url="https://new.fastaiode.top"
)
...
const client = new Anthropic({
  apiKey: 'YOUR_API_KEY',
  baseURL: 'https://new.fastaiode.top'
});
...
const curlStreamExample = `curl https://new.fastaiode.top/v1/messages \\
  -H "Content-Type: application/json" \\
  -H "x-api-key: YOUR_API_KEY" \\
  -H "anthropic-version: 2023-06-01" \\
  -d '{
...
const getModelsExample = `curl https://new.fastaiode.top/v1/models \\
  -H "x-api-key: YOUR_API_KEY"`
