...
client = OpenAI(
    ...
    base_url="https://sqllm.dpdns.org/v1"
)
...
const client = new OpenAI({
  apiKey: 'YOUR_API_KEY',
  baseURL: 'https://sqllm.dpdns.org/v1'
});
...
const curlExample = `curl https://sqllm.dpdns.org/v1/chat/completions \\
...
export OPENAI_BASE_URL=https://sqllm.dpdns.org/v1`
