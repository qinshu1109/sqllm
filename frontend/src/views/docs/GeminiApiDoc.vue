...
const curlExample = `curl "https://sqllm.dpdns.org/v1beta/models/gemini-2.0-flash:generateContent" \\
...
genai.configure(
    ...
    transport="rest",
    client_options={"api_endpoint": "sqllm.dpdns.org"}
)
...
url = "https://sqllm.dpdns.org/v1beta/models/gemini-2.0-flash:generateContent"
headers = {
...
const curlStreamExample = `curl "https://sqllm.dpdns.org/v1beta/models/gemini-2.0-flash:streamGenerateContent" \\
  -H "Content-Type: application/json" \\
  -d '{
    "contents": [
      {
...
genai.configure(api_key="YOUR_API_KEY", transport="rest", client_options={"api_endpoint": "sqllm.dpdns.org"})
model = genai.GenerativeModel("gemini-2.0-flash")
...
export GEMINI_API_BASE=https://sqllm.dpdns.org`
...
const getModelsExample = `curl "https://sqllm.dpdns.org/v1beta/models?key=YOUR_API_KEY"`
